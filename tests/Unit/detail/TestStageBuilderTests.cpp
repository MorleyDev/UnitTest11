...
{
private:
	std::vector<ut11::detail::TestStep> m_steps;
	ut11::detail::TestStageBuilderImpl m_builder;

	std::vector< std::shared_ptr<ut11::detail::TestStageImpl> > m_expectedStages;
	std::vector< std::shared_ptr<ut11::detail::TestStageImpl> > m_resultingStages;
...
public:
	virtual void Run()
	{
		Given("TestSteps and a TestStageBuilder", [&](){
			...
			m_builder = ut11::detail::TestStageBuilderImpl();

			m_steps =
			{
				ut11::detail::TestStep("0", [](){}), ut11::detail::TestStep("1", [](){}), ut11::detail::TestStep("2", [](){}),
				ut11::detail::TestStep("3", [](){}), ut11::detail::TestStep("4", [](){}), ut11::detail::TestStep("5", [](){}), 
				ut11::detail::TestStep("6", [](){}), ut11::detail::TestStep("7", [](){}), ut11::detail::TestStep("8", [](){}),
				ut11::detail::TestStep("9", [](){}), ut11::detail::TestStep("10", [](){})
			};
		});

		When("Stages are pushed to a builder and it is Built", [&]() {

			m_expectedStages = std::vector< std::shared_ptr<ut11::detail::TestStageImpl> >();
			m_resultingStages = std::vector< std::shared_ptr<ut11::detail::TestStageImpl> >();
			...
			m_expectedStages.push_back(std::make_shared<ut11::detail::TestStageImpl>(m_steps[0], m_steps[1], m_steps[2], m_steps[6]));
			m_expectedStages.push_back(std::make_shared<ut11::detail::TestStageImpl>(m_steps[0], m_steps[1], m_steps[3], m_steps[6]));
			m_expectedStages.push_back(std::make_shared<ut11::detail::TestStageImpl>(m_steps[0], m_steps[4], m_steps[5], m_steps[6]));
			m_expectedStages.push_back(std::make_shared<ut11::detail::TestStageImpl>(ut11::detail::TestStep(), m_steps[9], m_steps[10], ut11::detail::TestStep()));
			m_expectedStages.push_back(std::make_shared<ut11::detail::TestStageImpl>(m_steps[7], ut11::detail::TestStep(), m_steps[8], ut11::detail::TestStep()));

			auto stages = m_builder.Build();
			for (std::size_t i = 0; i < stages.size(); ++i)
				m_resultingStages.push_back(std::static_pointer_cast<ut11::detail::TestStageImpl>(stages[i]));
